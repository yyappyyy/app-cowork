...
# === 月別サンプルデータ ===
# 収入サンプル（予算, 実績）: 給与, 副業, 投資収入, その他
SAMPLE_INCOME = [
    # 1月〜12月
    [(300000, 300000), (30000, 25000), (5000, 3200), (0, 0)],
    [(300000, 300000), (30000, 32000), (5000, 4100), (0, 0)],
    [(300000, 300000), (30000, 28000), (5000, 5500), (0, 10000)],
    [(300000, 300000), (30000, 30000), (5000, 4800), (0, 0)],
    [(300000, 300000), (30000, 35000), (5000, 6200), (0, 0)],
    [(300000, 300000), (30000, 27000), (5000, 3900), (0, 5000)],
    [(300000, 300000), (30000, 31000), (5000, 4500), (0, 0)],
    [(300000, 300000), (30000, 29000), (5000, 5100), (0, 0)],
    [(300000, 300000), (30000, 33000), (5000, 4700), (0, 0)],
    [(300000, 300000), (30000, 26000), (5000, 3800), (0, 0)],
    [(300000, 300000), (30000, 34000), (5000, 5900), (0, 0)],
    [(300000, 350000), (30000, 40000), (5000, 7200), (0, 30000)],
]

# 支出サンプル（予算, 実績）: 住居費, 水道光熱費, 食費, 日用品, 交通費, 通信費, 保険料, 医療費, 教育費, 娯楽費, 衣服費, 美容費, 交際費, その他
SAMPLE_EXPENSE = [
    [(80000, 80000), (15000, 18000), (50000, 52000), (8000, 7500), (15000, 14000), (10000, 10000), (15000, 15000), (5000, 3000), (10000, 8000), (15000, 12000), (10000, 5000), (5000, 4500), (10000, 8000), (5000, 3000)],
    [(80000, 80000), (15000, 16000), (50000, 48000), (8000, 9000), (15000, 13500), (10000, 10000), (15000, 15000), (5000, 2000), (10000, 10000), (15000, 14000), (10000, 8000), (5000, 5000), (10000, 12000), (5000, 4000)],
    [(80000, 80000), (15000, 14000), (50000, 55000), (8000, 8500), (15000, 16000), (10000, 10000), (15000, 15000), (5000, 6000), (10000, 9000), (15000, 18000), (10000, 15000), (5000, 5500), (10000, 15000), (5000, 5000)],
    [(80000, 80000), (15000, 13000), (50000, 49000), (8000, 7000), (15000, 14500), (10000, 10000), (15000, 15000), (5000, 4000), (10000, 12000), (15000, 13000), (10000, 6000), (5000, 4000), (10000, 10000), (5000, 2500)],
    [(80000, 80000), (15000, 12000), (50000, 53000), (8000, 8000), (15000, 15000), (10000, 10000), (15000, 15000), (5000, 1500), (10000, 8500), (15000, 16000), (10000, 7000), (5000, 5000), (10000, 9000), (5000, 4000)],
    [(80000, 80000), (15000, 15000), (50000, 51000), (8000, 9500), (15000, 14000), (10000, 10000), (15000, 15000), (5000, 3500), (10000, 10000), (15000, 11000), (10000, 4000), (5000, 4500), (10000, 13000), (5000, 3500)],
    [(80000, 80000), (15000, 17000), (50000, 56000), (8000, 8500), (15000, 16000), (10000, 10000), (15000, 15000), (5000, 2500), (10000, 9500), (15000, 20000), (10000, 5000), (5000, 5000), (10000, 11000), (5000, 6000)],
    [(80000, 80000), (15000, 16500), (50000, 54000), (8000, 9000), (15000, 17000), (10000, 10000), (15000, 15000), (5000, 4000), (10000, 8000), (15000, 22000), (10000, 6000), (5000, 5500), (10000, 8000), (5000, 5000)],
    [(80000, 80000), (15000, 14500), (50000, 50000), (8000, 7500), (15000, 14000), (10000, 10000), (15000, 15000), (5000, 3000), (10000, 11000), (15000, 14000), (10000, 9000), (5000, 4500), (10000, 10000), (5000, 3500)],
    [(80000, 80000), (15000, 13500), (50000, 52000), (8000, 8000), (15000, 15500), (10000, 10000), (15000, 15000), (5000, 5000), (10000, 10000), (15000, 16000), (10000, 12000), (5000, 5000), (10000, 9000), (5000, 4500)],
    [(80000, 80000), (15000, 14000), (50000, 51000), (8000, 7500), (15000, 14500), (10000, 10000), (15000, 15000), (5000, 2500), (10000, 9000), (15000, 13000), (10000, 8000), (5000, 4500), (10000, 11000), (5000, 3000)],
    [(80000, 80000), (15000, 18500), (50000, 65000), (8000, 12000), (15000, 18000), (10000, 10000), (15000, 15000), (5000, 3000), (10000, 8000), (15000, 25000), (10000, 15000), (5000, 6000), (10000, 20000), (5000, 10000)],
]

# 日別支出サンプルデータ（各月10件程度）
# (日付, 項目名, 金額, 支払方法, メモ)
SAMPLE_DAILY_EXPENSES = [
    # 1月
    [(3, "食料品", 3500, "クレジットカード", "スーパーまとめ買い"),
     (5, "外食", 1200, "QRコード決済", "ランチ"),
     (7, "電車", 500, "電子マネー", "通勤"),
     (10, "カフェ", 580, "電子マネー", "スタバ"),
     (12, "日用品", 2100, "現金", "ドラッグストア"),
     (15, "食料品", 4200, "クレジットカード", "週末買い出し"),
     (18, "外食", 3500, "クレジットカード", "友人と夕食"),
     (20, "コンビニ", 650, "電子マネー", ""),
     (23, "書籍", 1800, "クレジットカード", "技術書"),
     (28, "食料品", 3800, "クレジットカード", "スーパー")],
    # 2月
    [(2, "食料品", 4100, "クレジットカード", "スーパー"),
     (4, "カフェ", 480, "電子マネー", "タリーズ"),
     (8, "外食", 2500, "QRコード決済", "ラーメン"),
     (10, "電車", 1200, "電子マネー", "休日外出"),
     (14, "外食", 5000, "クレジットカード", "バレンタインディナー"),
     (16, "日用品", 1500, "現金", "100均"),
     (19, "食料品", 3600, "クレジットカード", "スーパー"),
     (22, "コンビニ", 430, "電子マネー", ""),
     (25, "美容院", 4500, "クレジットカード", "カット"),
     (27, "食料品", 2900, "クレジットカード", "スーパー")],
    # 3月
    [(1, "食料品", 3200, "クレジットカード", "スーパー"),
     (3, "外食", 1800, "QRコード決済", "カレー"),
     (6, "カフェ", 620, "電子マネー", "ドトール"),
     (9, "衣服", 8900, "クレジットカード", "春物セール"),
     (12, "食料品", 4500, "クレジットカード", "まとめ買い"),
     (15, "飲み会", 4000, "現金", "送別会"),
     (18, "電車", 800, "電子マネー", ""),
     (21, "日用品", 2800, "クレジットカード", "洗剤等"),
     (25, "外食", 2200, "QRコード決済", "寿司"),
     (30, "食料品", 3100, "クレジットカード", "スーパー")],
    # 4月
    [(2, "食料品", 3800, "クレジットカード", "スーパー"),
     (5, "外食", 1500, "QRコード決済", "うどん"),
     (8, "カフェ", 550, "電子マネー", "コメダ"),
     (10, "電車", 600, "電子マネー", "通勤"),
     (13, "食料品", 4000, "クレジットカード", "スーパー"),
     (16, "日用品", 3200, "現金", "ホームセンター"),
     (20, "外食", 2800, "クレジットカード", "焼肉"),
     (23, "コンビニ", 520, "電子マネー", ""),
     (26, "書籍", 2200, "クレジットカード", "ビジネス書"),
     (29, "食料品", 3500, "クレジットカード", "スーパー")],
    # 5月
    [(1, "食料品", 4200, "クレジットカード", "GW買い出し"),
     (3, "外食", 3200, "クレジットカード", "GW外食"),
     (5, "タクシー", 2500, "QRコード決済", "GW移動"),
     (8, "カフェ", 680, "電子マネー", "スタバ新作"),
     (12, "食料品", 3900, "クレジットカード", "スーパー"),
     (15, "日用品", 1800, "現金", "ドラッグストア"),
     (19, "外食", 1600, "QRコード決済", "パスタ"),
     (22, "電車", 900, "電子マネー", ""),
     (26, "飲み会", 5000, "現金", "歓迎会"),
     (30, "食料品", 3400, "クレジットカード", "スーパー")],
    # 6月
    [(2, "食料品", 3600, "クレジットカード", "スーパー"),
     (4, "外食", 1400, "QRコード決済", "定食"),
     (7, "カフェ", 500, "電子マネー", "タリーズ"),
     (10, "日用品", 4500, "クレジットカード", "梅雨対策グッズ"),
     (13, "食料品", 4100, "クレジットカード", "スーパー"),
     (16, "電車", 700, "電子マネー", ""),
     (20, "外食", 2000, "QRコード決済", "中華"),
     (23, "コンビニ", 380, "電子マネー", ""),
     (26, "食料品", 3300, "クレジットカード", "スーパー"),
     (29, "飲み会", 4500, "現金", "同僚と")],
    # 7月
    [(1, "食料品", 3900, "クレジットカード", "スーパー"),
     (4, "外食", 2200, "QRコード決済", "ビアガーデン"),
     (7, "カフェ", 720, "電子マネー", "アイスコーヒー"),
     (10, "日用品", 2500, "現金", "夏物日用品"),
     (13, "食料品", 4800, "クレジットカード", "BBQ材料"),
     (16, "外食", 3000, "クレジットカード", "居酒屋"),
     (19, "電車", 1500, "電子マネー", "花火大会"),
     (22, "衣服", 5000, "クレジットカード", "夏物Tシャツ"),
     (25, "食料品", 3200, "クレジットカード", "スーパー"),
     (30, "コンビニ", 800, "電子マネー", "アイス")],
    # 8月
    [(2, "食料品", 4500, "クレジットカード", "お盆買い出し"),
     (5, "外食", 4000, "クレジットカード", "帰省先で外食"),
     (8, "タクシー", 3200, "QRコード決済", "帰省移動"),
     (11, "外食", 2800, "QRコード決済", "家族でランチ"),
     (14, "カフェ", 600, "電子マネー", "かき氷"),
     (17, "食料品", 3800, "クレジットカード", "スーパー"),
     (20, "日用品", 2200, "現金", "ドラッグストア"),
     (23, "外食", 1800, "QRコード決済", "そば"),
     (26, "食料品", 4200, "クレジットカード", "スーパー"),
     (30, "飲み会", 4500, "現金", "納涼会")],
    # 9月
    [(1, "食料品", 3500, "クレジットカード", "スーパー"),
     (4, "外食", 1600, "QRコード決済", "定食屋"),
     (7, "カフェ", 550, "電子マネー", "スタバ"),
     (10, "電車", 600, "電子マネー", ""),
     (13, "食料品", 4000, "クレジットカード", "スーパー"),
     (16, "日用品", 1900, "現金", "洗剤"),
     (19, "外食", 2500, "クレジットカード", "イタリアン"),
     (22, "書籍", 1500, "クレジットカード", "小説"),
     (25, "食料品", 3700, "クレジットカード", "スーパー"),
     (28, "コンビニ", 450, "電子マネー", "")],
    # 10月
    [(2, "食料品", 3800, "クレジットカード", "スーパー"),
     (5, "外食", 2000, "QRコード決済", "ハンバーガー"),
     (8, "カフェ", 620, "電子マネー", "秋限定ラテ"),
     (11, "衣服", 12000, "クレジットカード", "秋冬コート"),
     (14, "食料品", 4300, "クレジットカード", "スーパー"),
     (17, "日用品", 2400, "現金", "季節の入替え"),
     (20, "外食", 3500, "クレジットカード", "焼き鳥"),
     (23, "電車", 1000, "電子マネー", "紅葉狩り"),
     (26, "食料品", 3600, "クレジットカード", "スーパー"),
     (30, "飲み会", 5000, "現金", "ハロウィン")],
    # 11月
    [(1, "食料品", 3400, "クレジットカード", "スーパー"),
     (4, "外食", 1800, "QRコード決済", "ラーメン"),
     (7, "カフェ", 580, "電子マネー", "ホットココア"),
     (10, "日用品", 2000, "現金", "ドラッグストア"),
     (13, "食料品", 4100, "クレジットカード", "スーパー"),
     (16, "電車", 800, "電子マネー", ""),
     (19, "外食", 2200, "QRコード決済", "うどん"),
     (22, "書籍", 2500, "クレジットカード", "資格本"),
     (25, "食料品", 3900, "クレジットカード", "スーパー"),
     (28, "コンビニ", 520, "電子マネー", "")],
    # 12月
    [(1, "食料品", 5000, "クレジットカード", "スーパー年末"),
     (4, "外食", 3500, "クレジットカード", "忘年会ランチ"),
     (7, "カフェ", 650, "電子マネー", ""),
     (10, "衣服", 8000, "クレジットカード", "冬物セール"),
     (13, "食料品", 6000, "クレジットカード", "クリスマス準備"),
     (16, "飲み会", 6000, "現金", "忘年会"),
     (20, "外食", 5000, "クレジットカード", "クリスマスディナー"),
     (23, "日用品", 3500, "現金", "大掃除用品"),
     (26, "食料品", 8000, "クレジットカード", "おせち材料"),
     (30, "その他", 10000, "現金", "お年玉準備")],
]
...
def create_monthly_sheet(wb, month_name):
    ...
    income_data = SAMPLE_INCOME[month_idx]
    for i, cat in enumerate(INCOME_CATEGORIES):
        r = row + i
        budget, actual = income_data[i]
        ws.cell(row=r, column=2, value=cat).border = thin_border
        ws.cell(row=r, column=3, value=budget).border = thin_border  # Budget
        ws.cell(row=r, column=3).number_format = '#,##0'
        ws.cell(row=r, column=4, value=actual).border = thin_border  # Actual
    ...
    row += 1
    expense_data = SAMPLE_EXPENSE[month_idx]
    for i, cat in enumerate(EXPENSE_CATEGORIES):
        r = row + i
        budget, actual = expense_data[i]
        ws.cell(row=r, column=2, value=cat).border = thin_border
        ws.cell(row=r, column=3, value=budget).border = thin_border
        ws.cell(row=r, column=3).number_format = '#,##0'
        ws.cell(row=r, column=4, value=actual).border = thin_border
        ws.cell(row=r, column=4).number_format = '#,##0'
    ...
    # Empty rows for daily logging (31 days) - fill with sample data
    daily_data = SAMPLE_DAILY_EXPENSES[month_idx]
    for i in range(1, 32):
        r = log_row + i
        for c in range(2, 7):
            ws.cell(row=r, column=c).border = thin_border

    # Fill in sample daily expenses
    for i, (day, item, amount, payment, memo) in enumerate(daily_data):
        r = log_row + 1 + i
